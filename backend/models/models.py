...
class Site(db.Model):
    ...
    habitats = db.relationship('Nomenclature', secondary='cor_site_habitat', back_populates='sites',passive_deletes=True)
    departements = db.relationship('Departement', secondary='cor_site_departement', back_populates='sites',passive_deletes=True)
...
class Acteur(db.Model):
    ...
    acteur_origine_id = db.Column(db.Integer)
